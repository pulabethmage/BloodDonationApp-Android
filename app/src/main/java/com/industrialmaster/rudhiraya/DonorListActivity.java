...
public class DonorListActivity extends Activity implements Response.Listener<String>,Response.ErrorListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        donorslistview = findViewById(R.id.listview_donors);
    ...
    public void loadDonors() {
        ...
        String url ="http://192.248.85.22/rudhiraya.tk/register/donors_list.php";
    ...
    public void setDonors(JSONArray response) {
