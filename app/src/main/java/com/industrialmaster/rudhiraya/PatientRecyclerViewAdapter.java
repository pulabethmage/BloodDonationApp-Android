...
public class PatientRecyclerViewAdapter extends RecyclerView.Adapter<PatientRecyclerViewAdapter.ViewHolder>{
    ...
    public PatientRecyclerViewAdapter( Context mContext, ArrayList<String> mImages, ArrayList<String> mImageNames, ArrayList<String> mImageGender, ArrayList<String> mImageAge, ArrayList<String> mImageBloodgroup) {
       ...
       /* Glide.with(mContext)
        ...
        viewHolder.parentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //if not move to registration page or move to patients detail page

               // Intent intent = new Intent(mContext,DonateBloodActivity.class);
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mContext.startActivity(intent);
                //Toast.makeText(mContext,mImageNames.get(i)+" "+mImageGender.get(i)+" "+mImageAge.get(i)+" "+mImageBloodgroup.get(i),Toast.LENGTH_LONG).show();
